...
class RQuery {
	 ...
	 * @returns {RQuery|string} The current RQuery instance for chaining when setting text content,
	 or the current text content when getting.
	 */
	text(textContent) {
	 ...
	 * @param {function(Event): void} callback - The event listener function to execute
	 * when the selected element is clicked. The function will receive the event object as its argument.
	 * @returns {RQuery} The current RQuery instance for
	 */
	click(callback) {
	 ...
	 * @param {function(Event): void} [options.onInput] - The event listener 
	...
	numberInput(limit) {
		if (
			...
			throw new Error('Element must be an input with the type "number" ');
	...
	creditCardInput(){
		...
		if (
			...
			throw new Error('Element must be an input with the type "text" ');
	 ...
	 * @param {string | string[]} classNames - A single class name or an array of class names to add
	 * to he element.
	 ...
	 * @param {string} attributeName - The name of the attribute to det or get.
	 * @param {string} [value] - The value to set for the attribute. If not provided,
	 the current value of the attribute will be returned.
	 * @returns {RQuery|string} The current RQuery instance for chaining (if setting)
